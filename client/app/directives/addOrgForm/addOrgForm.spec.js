...
import {AddOrgFormController} from './addOrgForm.controller';
...
describe('AddOrgForm', ()=>{
  ...
  beforeEach(window.module(addOrgForm.name));
  beforeEach(inject((_$rootScope_)=>{
    $rootScope = _$rootScope_;
    makeController = ()=>{
      return new AddOrgFormController();
    };
  }));
  ...
  describe('Directive', ()=>{
      ...
      let directive = addOrgFormDirective();
      ...
      it('should use the right controller', ()=>{
        expect(directive.controller).to.equal(AddOrgFormController);
      });
  });
});
